...
public enum ApiMsgEnum {
    ...
    USER_WECHAT_MINI_BIND_OTHER("api.response.user.wechatMiniBindOther", "当前微信已绑定其他账号,请勿重复操作"),
    ...
    USER_PUSH_TYPE_PRESET_NO_EDIT("api.response.userPush.typePresetNoEdit", "系统预置推送方式,禁止编辑操作"),
